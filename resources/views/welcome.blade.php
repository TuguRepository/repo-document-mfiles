...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
        body {
            background: url('https://cms-tpi.afedigi.com/files/2022/04/6.-Pict.-News-BERAGAM-PRODUK-DAN-LAYANAN-TUGU-INSURANCE-YANG-OPTIMAL-UNTUK-KEBUTUHAN-PELANGGAN-scaled.jpg') no-repeat center center/cover;
            min-height: 100vh;
        }
    </style>
        @endif
    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
        ...
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                ...
                <div class="bg-[#fff2f2] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[440px] shrink-0 overflow-hidden">
                    {{-- Laravel Logo --}}
                    <body class="flex items-center justify-center min-h-screen text-white text-center">
    <div class="bg-black bg-opacity-100 p-10 rounded-lg shadow-lg w-full max-w-md">
        <img src="https://jb-app-backend-public-assets.s3.amazonaws.com/media/career_portal_logo_direct_upload/Logo_Tugu_Insurance_PNG.png" alt="logo.png" class="w-32 mx-auto mb-4">
        <h3 class="text-3xl font-bold">Welcome</h3>
        <p class="text-lg mb-4">Sistem Tata Kelola</p>
        <p class="text-lg font-semibold">Tugu Insurance</p>
                </div>
            </main>
        </div>
