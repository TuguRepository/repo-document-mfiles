<x-guest-layout>
    <style>
        /* CSS for enhancing the reset password page */
        body {
        ...
        <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-block">
                ...
                <div class="input-container">
                    ...
                    <input id="email" class="form-input input-with-icon" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" />
                </div>
            </div>
            ...
            <div class="form-block">
                ...
                <div class="input-container">
                    ...
                    <input id="password" class="form-input input-with-icon" type="password" name="password" required autocomplete="new-password" />
                </div>
            </div>
            ...
            <div class="form-block">
                ...
                <div class="input-container">
                    <i class="fas fa-lock input-icon"></i>
                    <input id="password_confirmation" class="form-input input-with-icon" type="password" name="password_confirmation" required autocomplete="new-password" />
                </div>
            </div>

            <div class="flex items-center justify-end mt-4" style="display: flex; justify-content: flex-end; margin-top: 1.5rem;">
                <button type="submit" class="custom-button">
                    <i class="fas fa-key" style="margin-right: 8px;"></i>{{ __('Reset Password') }}
                </button>
            </div>
        </form>
    </x-authentication-card>
